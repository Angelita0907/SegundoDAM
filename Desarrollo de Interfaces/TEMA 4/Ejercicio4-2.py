...
# importamos para que lea el fichero csv
fichero_csv = "TEMA 4/DI_U05_A02_PP_E_01.csv"
df = pd.read_csv(fichero_csv)

# en orden a lo indicado en el enunciado 
...
# creamos el número para ver la diferencia entre ventas
...
# aquí lo mismo pero con dos años en concreto
