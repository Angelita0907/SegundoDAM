...
@RestController
@RequestMapping("/LitMindSpring/auth")
public class AuthController {
	...
	public String login(@RequestBody Usuario usuario) {
		UsernamePasswordAuthenticationToken token = new UsernamePasswordAuthenticationToken(usuario.getNombre(),
				usuario.getClave());
	...
	public String registerUser(@RequestBody Usuario user) {
		...
		Usuario newUser = new Usuario(null, user.getNombre(), encoder.encode(user.getClave()));
