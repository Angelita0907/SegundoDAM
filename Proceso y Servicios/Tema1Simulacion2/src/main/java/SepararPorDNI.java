...
public class SepararPorDNI {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		SepararPorDNI contador = new SepararPorDNI();
		//List<String> resultado = contador.contarDNI(fichero+"/datos.txt");
		List<String> resultado = contador.contarDNI(ruta);
		...
		String ficheroResultado = fichero + "DNIs.txt";
		contador.escribeFichero(ficheroResultado, resultado);

	}

	public List<String> contarDNI(String ruta) throws FileNotFoundException {

		List<String> totalDNIs = new ArrayList<String>();
		...
		try {
			...
			System.out.println("DNIs:"+contador);
